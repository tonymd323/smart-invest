...
_版本：v2.4 | 日期：2026-03-28 | 全模块已上线 + 14 项数据质量问题修复完成_

---

## 架构原则

三层分离 | 数据驱动 | 自动降级 | 零重复 | 双池分离
...
- 数据质量校验
- `fetch_and_apply_consensus()` → ConsensusProvider 获取一致预期 → 计算 expectation_diff_pct
...
_架构 v2.4 | 2026-03-28 18:58 | 全模块上线 + 14 项 bug 修复 + 超预期算法修复 + QuoteProvider 字段修正_
