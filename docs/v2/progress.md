...
_版本：v2.6 | 日期：2026-03-29 | 状态：后端完成 + 前端优化中 + ConsensusProvider 多源从严待开发 ⏳_
...
| M17 | ConsensusProvider 多源从严 | ⏳ | 待开始 |
...
_进度 v2.6 | 2026-03-29 前端问题排查 + ConsensusProvider 多源从严方案已确认_
